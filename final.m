...
%step=0.001;   % любой, желательно не ниже 0.001
xi_3 = 3; % ksi_3*
%--------------------------------------
...
options_W = odeset('AbsTol',1e-06,'RelTol',1e-03,'Refine','8');
...
for n = 0:N_Max
    ...
    for m = 0:M_N
        ...
        w_xi3_1 = RWEF_13(sqr_ro,w2,l_1,h_1,i3_1,ellipsoid_condition,h_A,xi_3,options_W);
        ...
        w_xi3_2 = RWEF_13(sqr_ro,w2,l_2,h_2,i3_2,ellipsoid_condition,h_A,xi_3,options_W);
        Psi_2 = Xi_1_2(n_theta) * Xi_2_2(n_fi);
        
        parfor q = 1:n_theta
            for j = 1:n_fi
                term_1(q, j) = term_1(q, j) + (e_1 * Xi_1_1(q) * Xi_2_1(j) * Psi_1 *w_xi3_1);
                term_2(q, j) = term_2(q, j) + (e_2 * Xi_1_2(q) * Xi_2_2(j) * Psi_2 *w_xi3_2);
            end
        end
    end
end
